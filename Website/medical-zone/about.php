...
<section class="header-uper">
      ...
      <div class="logo">
		<div>
			<table>
				<tr>
					<td width="600px" style="font-size:50px;font-family:forte;"> <font color="#428bca">Medical </font><font color="#000"> Zone</font> </td>
					<td> <br> <br>
						<font size="4px"> 
...
<!--Page Title-->
<section class="page-title text-center" style="background-image:url(images/nn.jpeg);">
    <div class="container">
...
<section class="story">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="images/about-1.jpeg" class="responsive" alt="story">
            </div>
            <div class="col-md-6">
                <div class="story-content">
                    ...
                    <h6>Mission</h6>
                    <p>To provide a hospital management information system and a fully
integrated solution that assists hospitals in the management of
medical services effectively, increases hospital operation efficiency
and improves patient care.</p>
                    <h6>Vision</h6>
                    <p>Provide the most compliant and secure environment for the transfer of
protected health information. Improve ROI workflow efficiency and
streamline medical exchange information processes. Consolidate release
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="gallery-item">
                    <img src="images/best-hospital-management-software.jpg" class="img-responsive" alt="gallery-image">
                    <a data-fancybox="images" href="images/best-hospital-management-software.jpg"></a>
                    <h3>Facility 01</h3>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="gallery-item">
                    <img src="images/box-img1.jpg" class="img-responsive" alt="gallery-image">
                    <a data-fancybox="images" href="images/box-img1.jpg"></a>
                    <h3>Facility 02</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, in.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="gallery-item">
                    <img src="images/box-img2.jpg" class="img-responsive" alt="gallery-image">
                    <a data-fancybox="images" href="images/box-img2.jpg"></a>
                    <h3>Facility 03</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, in.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="gallery-item">
                    <img src="images/oo.jpeg" class="img-responsive" alt="gallery-image">
                    <a data-fancybox="images" href="images/oo.jpeg"></a>
                    <h3>Facility 04</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, in.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="gallery-item">
                    <img src="images/rr.jpeg" class="img-responsive" alt="gallery-image">
                    <a data-fancybox="images" href="images/rr.jpeg"></a>
                    <h3>Facility 05</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, in.</p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="about-widget">
            <div class="footer-logo">
             <table>
				<tr>
					<td width="600px" style="font-size:50px;font-family:forte;"> <font color="#fff">Medical </font><font color="#fff"> Zone</font> </td>
					<td> <br> <br>
  ...
  <div class="footer-bottom">
    <div class="container clearfix">
      <div class="copyright-text">
         <p>&copy; Copyright 2021. All Rights Reserved by Medical Zone
