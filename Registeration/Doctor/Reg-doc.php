...
<html lang="en">
<head>
    <link rel="stylesheet" href="reg-doc.css">
    <meta charset="UTF-8">
...
$sql = "INSERT INTO doctor (fname, lname, password , email , phone , gender) VALUES ('".$_POST["first_name"]."','".$_POST["last_name"]."','".$_POST["Password"]."','".$_POST["email"]."','".$_POST["phone"]."','".$_POST["gender"]."')";
